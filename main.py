...
#         print(f'size {len(mst_edges_dist)}')
#         if len(mst_edges_dist) < 70:
#             print(mst_edges_dist)
#         print(f"Weight sum sequential: {weight_sum_seq}, {k}")
#         print(f"Weight sum distributed: {weight_sum_dist}, {k}")
